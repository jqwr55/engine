...
class GeometryPass : public RenderPass {
    public:
        ...
        BufferObject<GL_TRANSFORM_FEEDBACK_BUFFER> shadowRecordBuffer;
        
        TiledState states[2];

        uint query;
        uint tranformFeedbackState;
        ...
        BindlessTexture funclookupTable_64x64xhalf;
        ...
        Shader shadowShader;
        Shader fogComputeShader;
        Shader fogShadowShader;
        Shader debugShader;
        ...
        VertexArrayLayoutDescriptor shadowMatrixLayout;
        VertexArrayLayoutDescriptor shadowVertexRecordLayout;

        uint8_t volShadowVao[sizeof(VertexArray)];
